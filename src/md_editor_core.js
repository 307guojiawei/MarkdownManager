...
//    var code = loadDocument();
  ...
  //      value           : code,
        ...
        tocm            : true,             // [TOCM]自动生成下拉菜单的目录，默认关闭
        tocTitle        : "目录",                // 下拉菜单的目录的标题
        tocDropdown     : true,             // [TOC]自动生成下拉菜单的目录，默认关闭
        ...
        lang : {
            description : "GJW Editor ，基于 Editor.md&Wiz.editor 构建。",
            toolbar : {
    ...
    function setEmojiFilePath () {
        editormd.emoji.path = "./emoji/emojis/";
        editormd.twemoji.path = "./emoji/twemoji/36x36/";
    }
